...
def compose_prompt(state: AgentState) -> AgentState:
    ...
    sys = (
        ...
        "Отвечай по сути и своими словами, содержательно. "
        "Каждый смысловой блок начинай с новой строки"
        "Если нужно перечислить пункты, используй списки, вводную фразу списка заканчивай символом ':'."
        "при перечислении элементов (пунктов) списка, каждый пункт списка начинай с новой строки, с символа'- '. "
        "Не копируй большие куски исходного текста, не цитируй метки вроде 'TITLE:', 'URL:', 'TEXT:', 'PAGE:'. "
        "Не вставляй в ответ служебный символы и символы форматирования"
